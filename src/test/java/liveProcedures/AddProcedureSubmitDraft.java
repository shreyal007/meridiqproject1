...
public class AddProcedureSubmitDraft {
...
//	  Thread.sleep(5000);
	...
	void goToClient() throws InterruptedException
	{
  	...
  	@Test(priority=3)
  	void addProcedureSubmitDraft() throws InterruptedException
  	{
  		...
  		driver.findElement(By.xpath("//input[@placeholder='Procedure Title']")).sendKeys("New Procedure");
  		Thread.sleep(3000);

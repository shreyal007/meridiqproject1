...
public class AddNoteSubmitDraft {
...
//	  Thread.sleep(5000);
	...
	@Test(priority=3)
	void addNoteSubmitDraft() throws InterruptedException
	{
		...
		driver.findElement(By.xpath("//h5[text()='Records']/following::*[1]")).click();
  		...
  		driver.findElement(By.xpath("//input[@placeholder='Title']")).sendKeys("New Note");
  		Thread.sleep(3000);

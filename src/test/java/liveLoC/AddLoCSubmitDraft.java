...
public class AddLoCSubmitDraft 
{
...
//	  Thread.sleep(5000);
	...
	@Test(priority=3)
	void addLoCSubmitDraft() throws InterruptedException
	{
		
		driver.findElement(By.xpath("//h5[text()='Records']/following::*[1]")).click();
  		Thread.sleep(3000);
  		
  		driver.findElement(By.xpath("//div[text()='Letters of Consents']")).click();
  		Thread.sleep(3000);
  		
  		WebElement e = driver.findElement(By.xpath("//input[@placeholder='Select a consent']"));
  		e.click();
  		Thread.sleep(3000);
  		
  		Actions a = new Actions(driver);
  		
  		a.sendKeys(e, "ENG - Botulinumtoxin").perform();
  		a.sendKeys(Keys.ENTER).build().perform();
  		Thread.sleep(3000);
  		
  		WebElement e1 = driver.findElement(By.xpath("//input[@placeholder='Select a option']"));
  		e1.click();
  		Thread.sleep(3000);
  		
  		a.sendKeys(e1, "I do not authorize").perform();
  		a.sendKeys(Keys.ENTER).build().perform();
  		Thread.sleep(3000);
  		
  		//p[text()='I do not authorize']
  		
  		driver.findElement(By.xpath("//p[text()='I, Shreyal Shah herby accept this consent']")).click();
  		Thread.sleep(3000);
